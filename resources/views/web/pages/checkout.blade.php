                    ...
                    <div class="container-tmp">
                        <div class="checkout__container__div">
                            ...
                            <div id="checkout__form" class="checkout__form hidden__div">
                                ...
                                @enderror
                                {{-- @endif --}}
                                <textarea placeholder="Comment" type="text" id="comment" name="comment" value="{{old('comment')}}"></textarea>
                            </div>
                            ...
                            <div id="delivery__container" class="delivery__container hidden__div">
                                <div class="delivery__buttons">
                                    <select value="{{old('deliveryMethod')}}" onchange="showDelivery(this.value)" class="green-text delivery__select" name="deliveryMethod">
                                ...
                                <div id="dpdSelect" class="visible__div">
                                    <select value="{{old('deliveryPlace_dpd')}}" name="deliveryPlace_dpd" class="green-text delivery__select">
                                ...
                                <div id="omnivaSelect" class="hidden__div">
                                    <select value="{{old('deliveryPlace_omniva')}}" name="deliveryPlace_omniva" class="green-text delivery__select">
                            ...
                            <div id="paymentDiv" class="btn-grid hidden__div">
                                <select value="{{old('paymentMethod')}}" class="green-text delivery__select" name="paymentMethod">
