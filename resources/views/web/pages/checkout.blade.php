                ...
                <form method="POST" action="/to_checkout">
                    ...
                    <div class="checkout__container__div">
                        ...
                        <div class="checkout__title">
                            ...
                            <img onclick="changeDataArrow('delivery__container', 'deliveryDataArrow')" id="deliveryDataArrow" class="close__arrow" src="{{ URL::asset('assets/svg/arrow.svg') }}"/>
                        </div>
                        ...
                        <div class="checkout__title">
                            ...
                            <img onclick="changeDataArrow('paymentDiv', 'paymentDataArrow')" id="paymentDataArrow" class="close__arrow" src="{{ URL::asset('assets/svg/arrow.svg') }}"/>
                        </div>
