    ...
    <div class="registration__container">
        ...
        <form class="registration__form" method="POST" action="/register">
            ...
            <div class="register__re-password__input">
                <input class="register__input @error('re-password') is-invalid @enderror" placeholder="Re-type password*"
                    type="password" id="re-password" name="re-password" value="{{ old('re-password') }}">
                @error('re-password')
                    <p class="register__error">{{ $message }}</p>
                @enderror
            </div>
